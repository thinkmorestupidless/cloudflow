...
lazy val step0 = appModule("step0")
    ...
    // NOTE: The CloudflowLibraryPlugin is used instead of CloudflowPekkoPlugin purely to make the code compile
    // NOTE: In a normal project it is required to enable to CloudflowPekkoPlugin instead, see step3.
