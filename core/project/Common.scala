...
object Common extends AutoPlugin {
  ...
  val javadocDisabledFor = Set(
    ...
    "/cloudflow-pekko/target/java/cloudflow/pekkostream/PekkoStreamletLogic.java",
    "/cloudflow-spark/target/java/cloudflow/spark/SparkStreamletLogic.java",
    // from JDK 11 failures
    "/cloudflow-pekko-testkit/target/java/cloudflow/pekkostream/testkit/TestContext$.java",
    "/cloudflow-pekko-testkit/target/java/cloudflow/pekkostream/testkit/TestContext.java",
    "/cloudflow-pekko-testkit/target/java/cloudflow/pekkostream/testkit/TestContextException$.java",
    "/cloudflow-pekko-testkit/target/java/cloudflow/pekkostream/testkit/TestContextException.java",
    "/cloudflow-pekko-testkit/target/java/cloudflow/pekkostream/testkit/javadsl/Completed.java",
    "/cloudflow-pekko-testkit/target/java/cloudflow/pekkostream/testkit/javadsl/ConfigParameterValueImpl$.java",
    "/cloudflow-pekko-testkit/target/java/cloudflow/pekkostream/testkit/javadsl/ConfigParameterValueImpl.java",
    "/cloudflow-pekko-testkit/target/java/cloudflow/pekkostream/testkit/javadsl/Failed$.java",
    "/cloudflow-pekko-testkit/target/java/cloudflow/pekkostream/testkit/javadsl/Failed.java",
    "/cloudflow-pekko-testkit/target/java/cloudflow/pekkostream/testkit/scaladsl/Completed.java",
    "/cloudflow-pekko-testkit/target/java/cloudflow/pekkostream/testkit/scaladsl/ConfigParameterValueImpl$.java",
    "/cloudflow-pekko-testkit/target/java/cloudflow/pekkostream/testkit/scaladsl/ConfigParameterValueImpl.java",
    "/cloudflow-pekko-testkit/target/java/cloudflow/pekkostream/testkit/scaladsl/Failed$.java",
    "/cloudflow-pekko-testkit/target/java/cloudflow/pekkostream/testkit/scaladsl/Failed.java",
    "/cloudflow-pekko/target/java/cloudflow/pekkostream/PekkoStreamletRuntime.java",
    "/cloudflow-pekko/target/java/cloudflow/pekkostream/Earliest.java",
    "/cloudflow-pekko/target/java/cloudflow/pekkostream/Latest.java",
    ...
    "/cloudflow-streamlets/target/java/cloudflow/streamlets/PekkoClusterAttribute.java",
