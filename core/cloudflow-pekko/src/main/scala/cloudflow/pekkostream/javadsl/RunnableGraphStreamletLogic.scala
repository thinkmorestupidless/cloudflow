...
/** Can be used to define a [[cloudflow.pekkostream.PekkoStreamletLogic]] from a `RunnableGraph`, which will be
  * materialized and instrumented when the [[cloudflow.pekkostream.PekkoStreamlet]] is run.
  */
abstract class RunnableGraphStreamletLogic(context: PekkoStreamletContext) extends PekkoStreamletLogic()(context) {
