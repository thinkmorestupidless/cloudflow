...
import cloudflow.pekkostream.{ MultiData2, PekkoStreamletContext }
import cloudflow.streamlets.CodecOutlet

import scala.collection.immutable

@InternalApi
private[pekkostream] object MultiProducer {
  ...
  def flow2[O1, O2](outlet1: CodecOutlet[O1], outlet2: CodecOutlet[O2])(implicit
      context: PekkoStreamletContext): Flow[(MultiData2[O1, O2], Committable), (Unit, Committable), NotUsed] =
    Flow
      .fromGraph(
        graph2(
  ...
  def sink2[O1, O2](outlet1: CodecOutlet[O1], outlet2: CodecOutlet[O2], committerSettings: CommitterSettings)(implicit
      context: PekkoStreamletContext): Sink[(MultiData2[O1, O2], Committable), NotUsed] =
