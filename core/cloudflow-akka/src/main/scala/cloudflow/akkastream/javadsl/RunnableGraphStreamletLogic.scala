...
/** Can be used to define a [[cloudflow.akkastream.AkkaStreamletLogic]] from a `RunnableGraph`, which will be
  * materialized and instrumented when the [[cloudflow.akkastream.AkkaStreamlet]] is run.
  */
