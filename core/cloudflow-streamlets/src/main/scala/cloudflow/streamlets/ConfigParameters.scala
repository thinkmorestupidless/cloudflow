...
/** Describes arguments that have to be supplied when deploying a Cloudflow application. Each streamlet in an
  * application can require zero or more arguments. The configuration parameter contains information for the end user
  * entering the values and logic to validate those values so they are entered correctly.
  *
  * Streamlet developers can create their own configuration parameters by deriving from [[ConfigParameter]], the
  * parameter can use validation logic from a fixed set of types derived from [[ValidationType]].
  *
...
trait ConfigParameter {
  ...
  /** Translates the parameter to a
    * [[cloudflow.streamlets.descriptors.ConfigParameterDescriptor ConfigParameterDescriptor]], it's included in the
    * application descriptor to describe configuration parameter at application deployment time.
    */
...
/** Describes an integer configuration parameter.
  ...
  * @param defaultValue
  *   the default value used if the parameter is not specified at application deployment time.
  */
...
final case class IntegerConfigParameter(key: String, description: String = "", defaultValue: Option[Int] = None)
  ...
  /** Java API Gets the value for this configuration parameter.
    */
...
/** Describes a parameter that can be used for custom validation.
  ...
  *   description of the parameter
  * @param pattern
  *   a regular expression to be used to validate this parameter
  * @param defaultValue
  *   the default value used if the parameter is not specified at application deployment time.
  */
...
/** Describes a time duration as defined by [[https://github.com/lightbend/config/blob/main/HOCON.md#duration-format]]
  ...
  *
  * ns, nano, nanos, nanosecond, nanoseconds us, micro, micros, microsecond, microseconds ms, milli, millis,
  * millisecond, milliseconds s, second, seconds m, minute, minutes h, hour, hours d, day, days
  *
...
/** Describes a memory quantity as defined by
  ...
  *
  * "B", "b", "byte", "bytes", "kB", "kilobyte", "kilobytes", "MB", "megabyte", "megabytes", "GB", "gigabyte",
  * "gigabytes", "TB", "terabyte", "terabytes", "PB", "petabyte", "petabytes", "EB", "exabyte", "exabytes", "ZB",
  * "zettabyte", "zettabytes", "YB", "yottabyte", "yottabytes", "K", "k", "Ki", "KiB", "kibibyte", "kibibytes", "M",
  * "m", "Mi", "MiB", "mebibyte", "mebibytes", "G", "g", "Gi", "GiB", "gibibyte", "gibibytes", "T", "t", "Ti", "TiB",
  * "tebibyte", "tebibytes", "P", "p", "Pi", "PiB", "pebibyte", "pebibytes", "E", "e", "Ei", "EiB", "exbibyte",
  * "exbibytes", "Z", "z", "Zi", "ZiB", "zebibyte", "zebibytes", "Y", "y", "Yi", "YiB", "yobibyte", "yobibytes",
  *
  * Example on how to extract a duration value using config:
  * {{{
