...
trait CloudflowCRFormat extends DefaultJsonProtocol {
  implicit val metadataFormat: RootJsonFormat[Metadata] = jsonFormat3(Metadata.apply)
  implicit val cloudflowCRFormat: RootJsonFormat[CloudflowCR] = jsonFormat4(CloudflowCR.apply)
}
