...
import cloudflow.pekkostream.{ PekkoStreamlet, PekkoStreamletLogic }
import cloudflow.pekkostream.scaladsl.RunnableGraphStreamletLogic
import cloudflow.streamlets.StreamletShape
import cloudflow.pekkostream.testdata.TestData
...
class TestSinkRefSpec extends AnyWordSpec with Matchers with BeforeAndAfterAll {
  private implicit val system: ActorSystem = ActorSystem("CloudflowPekkoTestkitErrorReproducerSpec")
  ...
  object TestFixture {
    ...
    class TestStreamlet extends PekkoStreamlet {
      ...
      override protected def createLogic: PekkoStreamletLogic = new RunnableGraphStreamletLogic() {
  ...
  "Cloudflow Pekko TestKit" should {
