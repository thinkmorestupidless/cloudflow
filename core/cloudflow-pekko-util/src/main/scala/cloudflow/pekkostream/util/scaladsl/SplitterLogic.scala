...
import cloudflow.pekkostream.internal.MultiProducer
...
object Splitter {
  ...
  def sink[I, L, R](
      ...
      rightOutlet: CodecOutlet[R])(implicit context: PekkoStreamletContext): Sink[(I, Committable), NotUsed] = {
  ...
  def sink[I, L, R](
      ...
      committerSettings: CommitterSettings)(implicit context: PekkoStreamletContext): Sink[(I, Committable), NotUsed] =
    flow
...
abstract class SplitterLogic[I, L, R](inlet: CodecInlet[I], leftOutlet: CodecOutlet[L], rightOutlet: CodecOutlet[R])(
    implicit context: PekkoStreamletContext)
