...
object ProtoOutlet {
  ...
  /** Creates a ProtoOutlet.
    ...
    * @param partitioner
    *   The partitioner function for the outlet. The String result of the partitioner is used as a key for partitioning.
    * @param clazz
    *   The type of message that can be produced to this outlet
    */
  ...
  /** Creates a ProtoOutlet. Messages produced to the outlet are distributed in round-robin fashion to topic partitions.
    * @param name
    *   The name of the outlet
    * @param clazz
    *   The type of message that can be produced to this outlet
