...
[source,scala]
--
include::{cloudflow-examples-version}@docsnippets:ROOT:example$pekkostreams-scala/src/main/scala/cloudflow/pekkostreamsdoc/RecordSumFlow.scala[tag=all]
--
...
[source,scala]
--
include::{cloudflow-examples-version}@docsnippets:ROOT:example$pekkostreams-scala/src/main/scala/cloudflow/pekkostreamsdoc/RecordSumFlow.scala[tag=definition]
--
...
[source,scala]
--
include::{cloudflow-examples-version}@docsnippets:ROOT:example$pekkostreams-scala/src/main/scala/cloudflow/pekkostreamsdoc/RecordSumFlow.scala[tag=usage]
--
...
[source,scala]
--
include::{cloudflow-examples-version}@docsnippets:ROOT:example$pekkostreams-scala/src/main/scala/cloudflow/pekkostreamsdoc/ConfigCustomValidation.scala[tag=definition]
--
...
[source,scala]
--
include::{cloudflow-examples-version}@docsnippets:ROOT:example$pekkostreams-scala/src/test/scala/com/example/SampleSpec.scala[tag=config-value]
--
...
[source,java]
--
include::{cloudflow-examples-version}@docsnippets:ROOT:example$pekkostreams-java/src/test/java/com/example/SampleTest.java[tag=config-value]
--
...
[source,java]
--
include::{cloudflow-examples-version}@docsnippets:ROOT:example$pekkostreams-java/src/main/java/cloudflow/pekkostreamsdoc/FilterStreamlet.java[tag=definition]
--
...
[source,java]
----
include::{cloudflow-examples-version}@docsnippets:ROOT:example$pekkostreams-java/src/main/java/cloudflow/pekkostreamsdoc/FilterStreamlet.java[tag=usage]
----
