...
[source,hocon]
----
include::{cloudflow-examples-version}@docsnippets:ROOT:example$pekkostreams-scala/src/main/blueprint/blueprint.conf[tag=all]
----
...
[source,hocon]
----
include::{cloudflow-examples-version}@docsnippets:ROOT:example$pekkostreams-scala/src/main/blueprint/blueprint.conf[tag=streamlets]
----
