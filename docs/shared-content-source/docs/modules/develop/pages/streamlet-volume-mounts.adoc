...
[source,scala]
----
include::{cloudflow-examples-version}@docsnippets:ROOT:example$pekkostreams-scala/src/main/scala/cloudflow/pekkostreamsdoc/DataFileIngress.scala[]
----
...
[source,java]
----
include::{cloudflow-examples-version}@docsnippets:ROOT:example$pekkostreams-java/src/main/java/cloudflow/pekkostreamsdoc/FilterStreamlet.java[]
----
