...
[source,protobuf]
----
include::{cloudflow-examples-version}@docsnippets:ROOT:example$pekkostreams-grpc-scala/src/main/protobuf/sensordata.proto[tag=proto]
----
...
[source,scala]
----
include::{cloudflow-examples-version}@docsnippets:ROOT:example$pekkostreams-grpc-scala/src/main/scala/SensorDataIngress.scala[tag=logic]
----
...
[source,java]
----
include::{cloudflow-examples-version}@docsnippets:ROOT:example$pekkostreams-grpc-java/src/main/java/sensordata/SensorDataIngress.java[tag=logic]
----
