...
[source,scala]
----
include::{cloudflow-examples-version}@docsnippets:ROOT:example$pekkostreams-scala/src/main/scala/cloudflow/pekkostreamsdoc/DataHttpIngress.scala[tag=httpIngress]
----
...
[source,java]
----
include::{cloudflow-examples-version}@docsnippets:ROOT:example$pekkostreams-java/src/main/java/cloudflow/pekkostreamsdoc/DataHttpIngress.java[tag=httpIngress]
----
...
[source,scala]
----
include::{cloudflow-examples-version}@docsnippets:ROOT:example$pekkostreams-scala/src/main/scala/cloudflow/pekkostreamsdoc/DataStreamingIngress.scala[tag=httpStreamingIngress]
----
...
[source,java]
----
include::{cloudflow-examples-version}@docsnippets:ROOT:example$pekkostreams-java/src/main/java/cloudflow/pekkostreamsdoc/DataStreamingIngress.java[tag=httpStreamingIngress]
----
...
[source,scala]
----
include::{cloudflow-examples-version}@docsnippets:ROOT:example$pekkostreams-scala/src/main/scala/cloudflow/pekkostreamsdoc/DataHttpIngressCustomRoute.scala[tag=customRoute]
----
