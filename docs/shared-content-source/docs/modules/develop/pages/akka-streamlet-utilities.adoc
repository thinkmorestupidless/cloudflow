...
[source,scala]
----
include::{cloudflow-examples-version}@docsnippets:ROOT:example$pekkostreams-scala/src/main/scala/cloudflow/pekkostreamsdoc/DataSplitter.scala[tag=splitter]
----
...
[source,java]
----
include::{cloudflow-examples-version}@docsnippets:ROOT:example$pekkostreams-java/src/main/java/cloudflow/pekkostreamsdoc/DataSplitter.java[tag=splitter]
----
...
[source,scala]
----
include::{cloudflow-examples-version}@docsnippets:ROOT:example$pekkostreams-scala/src/main/scala/cloudflow/pekkostreamsdoc/DataMerge.scala[tag=merge]
----
...
[source,java]
----
include::{cloudflow-examples-version}@docsnippets:ROOT:example$pekkostreams-java/src/main/java/cloudflow/pekkostreamsdoc/DataMerge.java[tag=merge]
----
