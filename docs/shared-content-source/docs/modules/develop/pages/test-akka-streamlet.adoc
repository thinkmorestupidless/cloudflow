...
[source,scala]
----
include::{cloudflow-examples-version}@docsnippets:ROOT:example$build-pekko-streamlets-scala/step3/src/test/scala/com/example/TestProcessorSpec.scala[tag=imports]
----
...
[source,scala]
----
include::{cloudflow-examples-version}@docsnippets:ROOT:example$build-pekko-streamlets-scala/step3/src/main/scala/com/example/TestProcessor.scala[tag=processor]
----
...
[source,scala]
----
include::{cloudflow-examples-version}@docsnippets:ROOT:example$build-pekko-streamlets-scala/step3/src/test/scala/com/example/TestProcessorSpec.scala[tag=test]
----
...
[source,scala]
----
include::{cloudflow-examples-version}@docsnippets:ROOT:example$build-pekko-streamlets-scala/step3/src/test/scala/com/example/TestProcessorSpec.scala[tag=afterAll]
----
...
[source,java]
----
include::{cloudflow-examples-version}@docsnippets:ROOT:example$build-pekko-streamlets-java/step3/src/test/java/com/example/TestProcessorTest.java[tag=imports]
----
...
[source,java]
----
include::{cloudflow-examples-version}@docsnippets:ROOT:example$build-pekko-streamlets-java/step3/src/main/java/com/example/TestProcessor.java[tag=processor]
----
...
[source,java]
----
include::{cloudflow-examples-version}@docsnippets:ROOT:example$build-pekko-streamlets-java/step3/src/test/java/com/example/TestProcessorTest.java[tag=test]
----
...
[source,java]
----
include::{cloudflow-examples-version}@docsnippets:ROOT:example$build-pekko-streamlets-java/step3/src/test/java/com/example/TestProcessorTest.java[tag=init]
----
